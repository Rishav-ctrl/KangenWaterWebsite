...
const phData = [
  ...
  },
  {
    ...
    description:
      'आमाको दुध पिउने बच्चाहरुऒलाई पिलाउन र उनीहरुको खाना बनाउनको लागि प्रयोग गरिन्छ । एलोपेथिक औषधी सेवन गर्न का लागि भी क्लीन Water को प्रयोग गरिन्छ ।',
  ...
  return (
    <section className=" py-4 px-4 sm:px-16">
      ...
      <div className="space-y-6">
        {phData.map((item, idx) => (
          <div key={idx} className={`rounded-lg text-white p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4 ${item.color}`}>
            <div className="flex-1">
              <h4 className="text-md sm:text-lg font-bold whitespace-pre-line">{item.title}</h4>
